					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select class="form-control"id="changePageSize" onchange="changePageSize()">
									<option <c:if test="${param.pageSize==1}">selected</c:if>>1</option>
									<option <c:if test="${param.pageSize==2}">selected</c:if>>2</option>
									<option <c:if test="${param.pageSize==3}">selected</c:if>>3</option>
									<option <c:if test="${param.pageSize==4}">selected</c:if>>4</option>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li>
									<a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.lastPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
